...
def selftest():
    ...
    1. Load SAMPLE_FGM
    2. Read u_globalPaletteSeed (assert it equals 36, the native value)
    3. Copy to a temp file and modify seed to 123
    4. Save the temp copy
    5. Reload the temp copy and verify seed == 123
    6. Print 'probe ok' on success
    """
