...
# Add package directory to path so jwe3_config and variant_model resolve
...
# Resolve cobra-tools path via config / environment / auto-detection
...
try:
    ...
    raise RuntimeError(
        ...
        "Please run 'python setup_gui.py' to configure your cobra-tools path, or set the JWE3_COBRA_TOOLS environment variable."
    ) from e
